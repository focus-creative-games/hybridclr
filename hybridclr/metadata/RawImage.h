...
namespace metadata
{
	enum class LoadImageErrorCode
	{
		...
		DIFFERENTIAL_HYBRID_ASSEMBLY_NOT_DIFFERENTIAL_HYBRID_ASSEMBLY,
		DIFFERENTIAL_HYBRID_ASSEMBLY_HAS_BEEN_LOADED,
		DIFFERENTIAL_HYBRID_ASSEMBLY_ONLY_SUPPORT_AOT_ASSEMBLY,
		DIFFERENTIAL_HYBRID_ASSEMBLY_BAD_OPTION_DATA,
	};
