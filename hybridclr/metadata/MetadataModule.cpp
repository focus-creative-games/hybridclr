...
namespace metadata
{
    ...
    LoadImageErrorCode MetadataModule::LoadMetadataForAOTAssembly(void* dllBytes, uint32_t dllSize, HomologousImageMode mode)
    {
        ...
        {
            return LoadImageErrorCode::HOMOLOGOUS_ASSEMBLY_HAS_LOADED;
        }
